...
import { Audio, AudioComponentProps } from '../render/Audio';
...
export function RenderAudioStrategy({ as: CustomAudio }: RenderAudioStrategyProps) {
  ...
  return (
    <>
      <Audio media={strategy.media} mediaControlsDeps={mediaControlsDeps} audioCopmonent={CustomAudio}>
